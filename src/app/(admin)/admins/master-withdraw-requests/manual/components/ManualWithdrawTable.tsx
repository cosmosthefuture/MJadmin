...
import { useGetManualWithdrawRequestsQuery } from "@/redux/features/withdraw/WithdrawApiSlice";
...
export default function ManualWithdrawTable() {
  ...
  const { data, isLoading } = useGetManualWithdrawRequestsQuery({
    page: currentPage,
