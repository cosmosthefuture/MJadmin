...
import { useGetAgentUserWithdrawListsQuery } from "@/redux/features/agents/AgentUserWithdrawApiSlice";
...
export default function AgentManualWithdrawTable() {
  ...
  const { data, isLoading } = useGetAgentUserWithdrawListsQuery(
