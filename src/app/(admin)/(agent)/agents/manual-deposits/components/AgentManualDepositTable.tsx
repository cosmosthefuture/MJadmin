...
import { useGetAgentUserDepositListsQuery } from "@/redux/features/agents/AgentUserDepositApiSlice";
...
export default function AgentManualDepositTable() {
  ...
  const { data, isLoading } = useGetAgentUserDepositListsQuery(
