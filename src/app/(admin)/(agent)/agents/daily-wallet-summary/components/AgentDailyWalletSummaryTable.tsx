...
import { useGetAgentDailyWalletSummaryQuery } from "@/redux/features/agents/AgentDailyWalletSummaryApiSlice";
...
export default function AgentDailyWalletSummaryTable() {
  ...
  const { data, isLoading } = useGetAgentDailyWalletSummaryQuery(
    { page, per_page },
    { skip: authType !== "agent" }
  );
  ...
  const onPageChange = (nextPage: number) => {
    router.push(`/agents/daily-wallet-summary?page=${nextPage}&per_page=${per_page}`);
  };
