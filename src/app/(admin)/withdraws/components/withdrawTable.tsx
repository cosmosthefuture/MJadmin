...
} from "@/redux/features/withdraw/WithdrawApiSlice";
...
export default function WithdrawTable() {
  ...
  const [approveWithdrawRequest, { isLoading: isApproving }] = useApproveWithdrawRequestMutation();
  const [rejectWithdrawRequest, { isLoading: isRejecting }] = useRejectWithdrawRequestMutation();
            ...
            <Table>
              ...
              <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                {withdraws.map((withdraw, index) => {
                  const statusColor = statusColorMap[withdraw.status] ?? "dark";
                  return (
