...
import { useGetMasterDailyCashbookRecordsQuery } from "@/redux/features/masters/MasterDailyCashbookRecordApiSlice";

export default function MasterDailyCashbookRecordsTable() {
  ...
  const { data, isLoading } = useGetMasterDailyCashbookRecordsQuery(
    { page, per_page, from: fromDate, to: toDate },
    { skip: authType !== "master" || !fromDate || !toDate || fromDate > toDate }
  );
  ...
  const onPageChange = (nextPage: number) => {
    router.push(`/master/daily-cashbook-records?${buildQueryString(nextPage)}`);
  };
