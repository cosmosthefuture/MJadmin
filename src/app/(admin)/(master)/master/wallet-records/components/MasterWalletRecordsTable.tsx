...
import { useGetMasterWalletRecordsQuery } from "@/redux/features/masters/MasterWalletRecordApiSlice";

export default function MasterWalletRecordsTable() {
  ...
  const { data, isLoading } = useGetMasterWalletRecordsQuery(
    { page, per_page },
  ...
  const onPageChange = (nextPage: number) => {
    router.push(`/master/wallet-records?page=${nextPage}&per_page=${per_page}`);
  };
